        ...
        return (
            <Fragment>
                ...
                <Grid item lg={12} xs={12} sm={12} md={12}>
                    <Typography variant="h3" style={{marginLeft:520, marginTop:30, color:"#00008B", fontWeight:"bold", fontSize:40,fontFamily: "Times New Roman"}}>Customer</Typography>
                </Grid>


                <Grid>
                    <img src={cus} style={{position:"absolute", top:100, left:600,width:100,height:100}}/>
                </Grid>
                ...
                <Link to= "customer" underline="none">
