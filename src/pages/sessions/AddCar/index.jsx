...
function createData(idCar, registrationNO, brand, type, noOfPassengers, transmissionType, fuelType, color, frontViewImg, backViewImg, sideViewImg, internalViewImg, dailyRate, monthlyRate, freeKmForPrice, freeKmForDuration, lossDamageWaiver, priceForExtraKm, completeKm, update, deleted, maintain) {
    return {
        idCar,
        registrationNO,
        brand,
